...
export const MEDIA_GALLERY_DATA = [
  {
    ...
    videoMobileSrc: "/Hanboro-V1-720p.mp4"
  },
  {
    id: "media-2",
    num: "02",
        ...
        <div className="our-media-header">
          <div className="our-media-heading-group">
            ...
            <p className="our-media-subtitle-editorial">
              Live wrist captures and mechanical calibres in motion.
            </p>
          </div>

          <div className="our-media-actions-group">
            <a
          ...
          {MEDIA_GALLERY_DATA.map((item, idx) => {
            ...
            return (
              ...
              >
                ...
                {/* Active Feature Center Card Content: Only rendered when active for 120fps performance */}
                {isActive && (
