...
export const HIGH_RES_IMAGE_MAP = {
  ...
  "/watch-cyber-green-skeleton-front-transparent-thumb.webp": "/catalog/hbr-918-auto-torque-green-front.jpg",
  ...
  "/watch-double-balance-cantilever-rosegold-front-transparent-thumb.webp": "/catalog/hbr-985-auto-apex-rg-blk-front.png",
  "/watch-double-balance-cantilever-yellow-front-transparent-thumb.webp": "/catalog/hbr-985-auto-apex-slv-ylw-front.png",
...
// ──────────────────────────────────────────────────────────────────────────────
// Storewide MRP Discount Configuration & Helper (Shopify + Static Baseline)
// ──────────────────────────────────────────────────────────────────────────────
export function getMrpDiscountConfig(override = null) {
  if (override && typeof override === "object") {
    return {
      enabled: override.enabled !== false,
      percent: typeof override.percent === "number" && override.percent >= 0 && override.percent <= 90 ? override.percent : 20,
    };
  }
...
export function getWatchPricing(watch, overrideConfig = null) {
  ...
  const isDiscountWatchDisabled =
    watch.showMrpDiscount === false ||
    watch.enableDiscount === false ||
    watch.specs?.showMrpDiscount === false ||
    watch.specs?.enableDiscount === false;
